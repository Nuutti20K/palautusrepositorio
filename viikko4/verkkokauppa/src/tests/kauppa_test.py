...
class TestKauppa(unittest.TestCase):
    ...
    def test_jaljella_olevan_ja_loppuneen_tuotteen_ostos(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_kaupan_metodi_aloita_asiointi_nollaa_tiedot(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
        ...
        pankki_mock.tilisiirto.assert_called_with("matti", 42, "11111", "33333-44455", 5)

    def test_joka_ostokselle_luodaan_uusi_viite(self):
        pankki_mock = Mock()
        ...
        pankki_mock.tilisiirto.assert_called_with("matti", 3, "11111", "33333-44455", 5)

        kauppa.aloita_asiointi()
        kauppa.lisaa_koriin(1)
        kauppa.tilimaksu("kalle", "22222")

        pankki_mock.tilisiirto.assert_called_with("kalle", 4, "22222", "33333-44455", 5)
